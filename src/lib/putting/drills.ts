...
export const LOCKED_INDOOR_DRILLS: PuttingDrill[] = [
  {
    ...
    reps: 20,
    scoring_inputs: [
      { id: 'through_gate', label: 'Through gate', points: 1 },
    ...
    level_bands: [
      ...
      { min: 11, max: 15, label: 'Decent' },
      { min: 16, max: 18, label: 'Good' },
...
export const INDOOR_PRACTICE_SETS = [
  {
    ...
    drillNames: ['Start-Line Gate', 'Putter Gate Stroke', '1 m Automatic Putts', 'Pressure Ladder'],
  },
  {
    id: 'set-b',
  ...
  },
  {
    ...
    drillNames: ['Putter Gate Stroke', 'Start-Line Gate', 'Random Distance Call', 'Pressure Ladder'],
  },
  {
    id: 'full',
    name: 'Full 8-Drill Test',
